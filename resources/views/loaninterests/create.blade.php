            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header bg-dark text-white">
                        <h3 class="m-0 font-weight-bold">{{ __('Add Loan Interest') }}</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('loaninterests.store') }}" method="POST">
                            @csrf
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control @error('months') is-invalid @enderror" id="months" name="months" required>
                                            ...
                                            <option value="8" {{ old('months') == '8' ? 'selected' : '' }}>8 Months</option>
                                            <option value="12" {{ old('months') == '12' ? 'selected' : '' }}>12 Months</option>
                                            <option value="24" {{ old('months') == '24' ? 'selected' : '' }}>24 Months</option>
                                            <option value="36" {{ old('months') == '36' ? 'selected' : '' }}>36 Months</option>
                                        </select>
                                        @error('months')
