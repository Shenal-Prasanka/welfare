    ...
    <div class="container-fluid">
        <div class="row justify-content-center"> <!-- Center align the row -->
                        ...
                        <div class="card-body">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <div class="input-group-append">
                                    <div class="input-group-text text-info"><span class="fas fa-user"></span></div>
                                </div>
                                @error('name')
                            ...
                            <div class="input-group mb-3">
                                ...
                                <div class="input-group-append">
                                    <div class="input-group-text text-info"><span class="fas fa-envelope"></span></div>
                                </div>
                                @error('email')
                                <span class="error invalid-feedback">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="input-group mb-3">
                                <input type="text" name="mobile"
                                       ...
                                       placeholder="Mobile" value="{{ old('mobile', auth()->user()->mobile) }}" required>
                                <div class="input-group-append">
                                    <div class="input-group-text text-info"><span class="fas fa-phone"></span></div>
                                </div>
                                @error('mobile')
                                <span class="error invalid-feedback">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="input-group mb-3">
                                <input type="text" name="address"
                                       ...
                                       placeholder="Address" value="{{ old('address', auth()->user()->address) }}" required>
                                <div class="input-group-append">
                                    <div class="input-group-text text-info"><span class="fas fa-map-marker-alt"></span></div>
                                </div>
                                @error('address')
                                <span class="error invalid-feedback">{{ $message }}</span>
                                @enderror
                           ...
                           <!-- Profile Image -->
                            ...
                            <div class="input-group mb-3">
                                <input type="file" name="profile_image" accept="image/*" class="form-control @error('profile_image') is-invalid @enderror">
                                <div class="input-group-append">
                                    <div class="input-group-text text-info"><span class="fas fa-image"></span></div>
                                </div>
                                @error('profile_image')
                                    <span class="error invalid-feedback">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="input-group mb-3">
                                ...
                                <div class="input-group-append">
                                    <div class="input-group-text text-info"><span class="fas fa-lock"></span></div>
                                </div>
                                @error('password')
                                <span class="error invalid-feedback">{{ $message }}</span>
                                @enderror
            ...
            <div class="col-lg-5">
                <div class="card">
                    <div class="card-header bg-gray">
                        <h5 class="text-center ">{{ __('My Profile') }}</h5>
                        </div>
                    <div class="card-body">
                       ...
                       <div class=" mb-3">
                            ...
                            @else
                                <i class="nav-icon fas fa-user-circle" style="font-size: 120px; color: #6c757d;"></i>
                            @endif
                        </div>
                         </div>
