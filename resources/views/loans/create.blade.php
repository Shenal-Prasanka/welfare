            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header bg-dark">
                        <h5 class="m-0 font-weight-bold text-white">{{ __('Create Loan Application') }}</h5>
                    </div>
                    <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select name="loan_type" class="form-select @error('loan_type') is-invalid @enderror" required>
                                                ...
                                                <option value="100000" {{ old('loan_type') == '100000' ? 'selected' : '' }}>Rs. 100,000</option>
                                                <option value="300000" {{ old('loan_type') == '300000' ? 'selected' : '' }}>Rs. 300,000</option>
                                            </select>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select name="rank" class="form-select @error('rank') is-invalid @enderror" required>
                                                ...
                                                @foreach($ranks as $rankItem)
                                                    <option value="{{ $rankItem->rank }}" {{ old('rank') == $rankItem->rank ? 'selected' : '' }}>{{ $rankItem->rank }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select name="previous_unit" class="form-select @error('previous_unit') is-invalid @enderror">
                                                ...
                                                @foreach($units as $unitItem)
                                                    <option value="{{ $unitItem->unit }}" {{ old('previous_unit') == $unitItem->unit ? 'selected' : '' }}>{{ $unitItem->unit }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="branch" class="form-control @error('branch') is-invalid @enderror" value="{{ old('branch') }}" required>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="account_no" class="form-control @error('account_no') is-invalid @enderror" value="{{ old('account_no') }}" required>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select name="guarantor1_rank" class="form-select @error('guarantor1_rank') is-invalid @enderror" required>
                                                ...
                                                @foreach($ranks as $rankItem)
                                                    <option value="{{ $rankItem->rank }}" {{ old('guarantor1_rank') == $rankItem->rank ? 'selected' : '' }}>{{ $rankItem->rank }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select name="guarantor1_previous_unit" class="form-select @error('guarantor1_previous_unit') is-invalid @enderror">
                                                ...
                                                @foreach($units as $unitItem)
                                                    <option value="{{ $unitItem->unit }}" {{ old('guarantor1_previous_unit') == $unitItem->unit ? 'selected' : '' }}>{{ $unitItem->unit }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select name="guarantor2_rank" class="form-select @error('guarantor2_rank') is-invalid @enderror" required>
                                                <option value="">{{ __('Select Rank') }}</option>
                                                @foreach($ranks as $rankItem)
                                                    <option value="{{ $rankItem->rank }}" {{ old('guarantor2_rank') == $rankItem->rank ? 'selected' : '' }}>{{ $rankItem->rank }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select name="guarantor2_previous_unit" class="form-select @error('guarantor2_previous_unit') is-invalid @enderror">
                                                <option value="">{{ __('Select Unit') }}</option>
                                                @foreach($units as $unitItem)
                                                    <option value="{{ $unitItem->unit }}" {{ old('guarantor2_previous_unit') == $unitItem->unit ? 'selected' : '' }}>{{ $unitItem->unit }}</option>
                                                @endforeach
                                            </select>
